...
public:
    ...
    MyParameterBase(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyDoubleParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyIntegerParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyBooleanParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyStringParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyNominalParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    MyDashArrayParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyColorParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyPositionalParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyDimensionalParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyRelativePositionalParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyRelativeDimensionalParameter(const QString& name, GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
    
    // reset the values of the parameter
    void reset() override;
};

class MyRelAbsAbsolutePositionalParameter : public MyPositionalParameter {
public:
    
    MyRelAbsAbsolutePositionalParameter(const QString& name, RelAbsVector* relAbsVector);
...
protected:
    RelAbsVector* _relAbsVector;
};

class MyRelAbsAbsoluteDimensionalParameter : public MyDimensionalParameter {
public:
    
    MyRelAbsAbsoluteDimensionalParameter(const QString& name, RelAbsVector* relAbsVector);
...
class MyRelAbsRelativePositionalParameter : public MyRelativePositionalParameter {
public:
    
    MyRelAbsRelativePositionalParameter(const QString& name, RelAbsVector* relAbsVector);
...
class MyRelAbsRelativeDimensionalParameter : public MyRelativeDimensionalParameter {
public:
    
    MyRelAbsRelativeDimensionalParameter(const QString& name, RelAbsVector* relAbsVector);
...
public:
    ...
    MyBoundingBoxXParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyBoundingBoxYParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyBoundingBoxWidthParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyBoundingBoxHeightParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyStrokeWidthParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyStrokeColorParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyStrokeDashArrayParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyFillParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
    
    MyFillParameter(GraphicalPrimitive2D* graphicalPrimitive2D);
...
public:
    ...
    MyFontFamilyParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyFontSizeParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyFontWeightParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyFontStyleParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyTextAnchorParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
...
public:
    ...
    MyVTextAnchorParameter(GraphicalObject* graphicalObject, Transformation2D* styleFeatures);
